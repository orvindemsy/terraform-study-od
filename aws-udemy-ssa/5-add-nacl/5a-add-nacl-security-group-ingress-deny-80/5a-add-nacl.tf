...
resource "aws_instance" "modified-bastion-httpd-server" {
  ami           = "ami-0599b6e53ca798bb2"
  instance_type = "t2.micro"
  subnet_id     = aws_subnet.abc-public-subnetA.id

  vpc_security_group_ids = [aws_security_group.public-main-abc-sg.id]  # Attach the security group
...
resource "aws_default_network_acl" "default" {
  default_network_acl_id = aws_vpc.main-abc.default_network_acl_id
